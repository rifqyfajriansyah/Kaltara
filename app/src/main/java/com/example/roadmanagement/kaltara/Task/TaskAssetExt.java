...
public class TaskAssetExt extends AsyncTask<String, String, String> {
    ...
    public TaskAssetExt (final Context context, ArrayList<DetailDownload> listsegment, String ruas, int noseg, int subseg, SendId sendId){
        ...
        dialog.setMessage("Tambahan Asset Ruas "+ruas);
    ...
    protected void onPostExecute(String result) {
        ...
        fungsiAPI.downDrainExt(session.getKodeprov(), ruas, noseg, subseg, dialog, new SendId() {
            @Override
