...
public class TableSplAdapter extends RecyclerView.Adapter<TableSplAdapter.ViewHolder> {
    private ArrayList<DataSpLuar> mArrayList;
    private ArrayList<DataSpLuar> mArrayListo;
    ...
    public TableSplAdapter(ArrayList<DataSpLuar> mArrayList, ArrayList<DataSpLuar> mArrayListo, ArrayList<SingleSegment> kmku, Context mContex) {
    ...
    @Override
    public TableSplAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new TableSplAdapter.ViewHolder(LayoutInflater.from(mContex).inflate
                (R.layout.tabeltambahan, parent, false));
    }

    @Override
    public void onBindViewHolder(TableSplAdapter.ViewHolder holder, int position) {

        DataSpLuar current = mArrayList.get(position);
        DataSpLuar currento = mArrayListo.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private void onClickKu(ArrayList<DataSpLuar> arrayList) {
            ...
            if (session.getSurvey() == 1) {
                ...
                session.saveSPInt(Session.TAB_ATRIBUT, AnimationTab.getPosisiAtribut("SPL"));
        ...
        public void bindTO(DataSpLuar current, DataSpLuar currento, String stal, String tSubseg) {
