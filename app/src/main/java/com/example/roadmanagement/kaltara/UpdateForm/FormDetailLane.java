...
public class FormDetailLane extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_detail_lane);
        session = new Session(this);
        //spinner = findViewById(R.id.spinnerfragment);
        dbRuas = new DbRuas(this);

        //initRuas();
        vpPager = (ViewPager) findViewById(R.id.pagerformlane);
        adapterViewPager = new FormDetailLane.MyPagerAdapter(getSupportFragmentManager());
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0: // Fragment # 0 - This will show FirstFragment
                    return FragmentLaneDetail.newInstance(0,"");
                case 1: // Fragment # 0 - This will show FirstFragment different title
                    return FragmentLaneKolektif.newInstance(1, "", null);
