...
public class SpinnerTipe extends ArrayAdapter<String> {

    LayoutInflater inflater;
    String[] arrayData;

    public SpinnerTipe(Activity context, int idLayout, String[] arrayData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textView = rowview.findViewById(R.id.textWarna);
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textView = convertView.findViewById(R.id.textWarna);
