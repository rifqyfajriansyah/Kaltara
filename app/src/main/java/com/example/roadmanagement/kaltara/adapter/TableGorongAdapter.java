...
public class TableGorongAdapter extends RecyclerView.Adapter<TableGorongAdapter.ViewHolder> {
    private ArrayList<DataCrossDrain> mArrayList;
    private ArrayList<DataCrossDrain> mArrayListo;
    ...
    public TableGorongAdapter(ArrayList<DataCrossDrain> mArrayList, ArrayList<DataCrossDrain> mArrayListo, ArrayList<SingleSegment> kmku, Context mContex) {
    ...
    @Override
    public TableGorongAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new TableGorongAdapter.ViewHolder(LayoutInflater.from(mContex).inflate
                (R.layout.tabeltambahan, parent, false));
    }

    @Override
    public void onBindViewHolder(TableGorongAdapter.ViewHolder holder, int position) {

        DataCrossDrain current = mArrayList.get(position);
        DataCrossDrain currento = mArrayListo.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private void onClickKu(ArrayList<DataCrossDrain> arrayList) {
            ...
            if (session.getSurvey() == 1) {
                ...
                session.saveSPInt(Session.TAB_ATRIBUT, AnimationTab.getPosisiAtribut("Gorong"));
        ...
        public void bindTO(DataCrossDrain current, DataCrossDrain currento, String stal, String tSubseg) {
