...
public class FormDetailLahan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initRuas();
        vpPager = (ViewPager) findViewById(R.id.pagerformlahan);
        adapterViewPager = new FormDetailLahan.MyPagerAdapter(getSupportFragmentManager());
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0: // Fragment # 0 - This will show FirstFragment
                    return FragmentLahanDetail.newInstance(0,"");
                case 1: // Fragment # 0 - This will show FirstFragment different title
                    return FragmentLahanKolektif.newInstance(1, "", null);
