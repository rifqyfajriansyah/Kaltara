...
public class DataInletTrotoar {
    ...
    public static final String TABLE_NAME = "dataInletTrotoar";
    ...
    public DataInletTrotoar(String noprov, String noruas, int nosegment, int subsegment, String posisi, String keberadaan, String jenisPenampang, float tinggi, float panjang, float lebar, float tinggiSedimen, String jenisKonstruksi, String kondisiSaluran, String gambar, String icon, String lokasi) {
        this.noprov = noprov;
        this.noruas = noruas;
