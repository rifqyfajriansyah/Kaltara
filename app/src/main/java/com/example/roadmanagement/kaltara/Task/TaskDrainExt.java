...
public class TaskDrainExt extends AsyncTask<String, String, String> {
    ...
    public TaskDrainExt (final Context context, ArrayList<DetailDrainase> listDrainase, String ruas, SendId sendId){
        ...
        dialog.setMessage("Tambahan Asset Drainase "+ruas);
