...
public class TableMinletAdapter extends RecyclerView.Adapter<TableMinletAdapter.ViewHolder> {
    private ArrayList<DataInletMedian> mArrayList;
    private ArrayList<DataInletMedian> mArrayListo;
    ...
    public TableMinletAdapter(ArrayList<DataInletMedian> mArrayList, ArrayList<DataInletMedian> mArrayListo, ArrayList<SingleSegment> kmku, Context mContex) {
    ...
    @Override
    public TableMinletAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new TableMinletAdapter.ViewHolder(LayoutInflater.from(mContex).inflate
                (R.layout.tabeltambahan, parent, false));
    }

    @Override
    public void onBindViewHolder(TableMinletAdapter.ViewHolder holder, int position) {

        DataInletMedian current = mArrayList.get(position);
        DataInletMedian currento = mArrayListo.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private void onClickKu(ArrayList<DataInletMedian> arrayList) {
            ...
            if (session.getSurvey() == 1) {
                ...
                session.saveSPInt(Session.TAB_ATRIBUT, AnimationTab.getPosisiAtribut("Perkerasan"));
        ...
        public void bindTO(DataInletMedian current, DataInletMedian currento, String stal, String tSubseg) {
