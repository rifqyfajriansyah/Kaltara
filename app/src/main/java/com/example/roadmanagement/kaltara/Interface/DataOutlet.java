...
public class DataOutlet {
    ...
    public static final String TABLE_NAME = "dataOutlet";
    ...
    public DataOutlet(String noprov, String noruas, int nosegment, int subsegment, String posisi, String keberadaan, String jenisPenampang, float diameter, float lebar, float tinggi, String jenisKonstruksi, String kondisiSaluran, String gambar, String icon, String lokasi) {
        this.noprov = noprov;
        this.noruas = noruas;
