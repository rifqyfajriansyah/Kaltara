...
public class DataSpDalam {

    public static final String TABLE_NAME = "dataspdalam";
    ...
    public static final String COLUMN_LEBAR = "lebarspdalam";
    ...
    public DataSpDalam(String noprov, String noruas, int nosegment, int subsegment, String posisi, float lebar, String gambar, String icon, String lokasi) {
        this.noprov = noprov;
        this.noruas = noruas;
