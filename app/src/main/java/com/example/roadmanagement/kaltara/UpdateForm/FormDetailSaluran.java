...
public class FormDetailSaluran extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_detail_saluran);
        session = new Session(this);
        //spinner = findViewById(R.id.spinnerfragment);
        dbRuas = new DbRuas(this);

        //initRuas();
        vpPager = (ViewPager) findViewById(R.id.pagerformsaluran);
        adapterViewPager = new FormDetailSaluran.MyPagerAdapter(getSupportFragmentManager());
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0: // Fragment # 0 - This will show FirstFragment
                    return FragmentSaluranDetail.newInstance(0,"");
                case 1: // Fragment # 0 - This will show FirstFragment different title
                    return FragmentSaluranKolektif.newInstance(1, "", null);
